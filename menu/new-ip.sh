...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/tridebleng/ip/main/"
...
REPO="https://github.com/tridebleng/ip.git"
...
git remote add origin https://raw.githubusercontent.com/tridebleng/ip
git push -f https://${TOKEN}@github.com/tridebleng/ip.git &> /dev/null
